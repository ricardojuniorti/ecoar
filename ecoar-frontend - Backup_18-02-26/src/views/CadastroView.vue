...
const salvarItemRapido = async () => {
  ...
  try {
    ...
    // Atualiza a lista global e injeta no formulário
...
/* Ajustes para o Multiselect combinar com o Ecoar */
:deep(.multiselect__tag) { background: var(--ecoar-verde); border: 1px solid var(--ecoar-dourado); color: var(--ecoar-dourado); }
:deep(.multiselect__option--highlight) { background: var(--ecoar-verde); color: white; }
</style>